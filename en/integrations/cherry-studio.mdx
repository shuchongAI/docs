...
Cherry Studio allows you to customize model parameters for each conversation:

| Parameter | Description | Recommended Value |
|-----------|-------------|-------------------|
| **Temperature** | Controls randomness and creativity of output | `0.7` (balanced) to `1.0` (creative) |
| **Max Tokens** | Maximum length of a single response | `2048` - `4096` |
| **Top P** | Nucleus sampling parameter | `0.9` - `1.0` |
| **Frequency Penalty** | Reduces probability of repetition | `0.0` - `0.5` |
| **Presence Penalty** | Encourages new topics | `0.0` - `0.5` |

### Set Proxy (Optional)

If you need to access APIMart through a proxy:

1. Find the **"Network"** option in settings
