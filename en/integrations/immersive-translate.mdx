...
2. **APIMart API Key Obtained**  
   Login to [APIMart Console](https://apimart.ai/console/token) to get your API key (starts with `sk-`)
...
<Note>
**Configuration Notes:**
- **APIKEY**: Must be obtained from [APIMart Console](https://apimart.ai/console/token) and start with `sk-`
...
2. **Check API Key**:
   ...
   - Check if key is valid and has balance at [APIMart Console](https://apimart.ai/console/token)
...
Login to [APIMart Console](https://apimart.ai/console) to view detailed statistics:
