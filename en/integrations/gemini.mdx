...
2. **APIMart API Key**  
   Log in to [APIMart Console](https://api.apimart.ai/console/token) to obtain your API key (starts with `sk-`)

<Note>
**Tip:** If you don't have an APIMart account yet, register at [APIMart](https://api.apimart.ai) first and obtain an API key.
</Note>
...
<Note>
**Important:**
- Replace `sk-xxxxxxxxxxxx` with your actual API key from [APIMart Console](https://api.apimart.ai/console/token)
