...
- Fast version (40-90s) and high-quality version (90-300s) available
...
<ParamField body="model" type="string" required>
  ...
  Supported models:
  - `doubao-seedance-1-0-pro-fast` - Fast version, quick generation (40-90s), suitable for preview and iteration
  - `doubao-seedance-1-0-pro-quality` - High-quality version, longer generation time (90-300s), better quality
</ParamField>
