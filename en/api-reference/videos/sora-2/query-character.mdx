...
<ResponseField name="data" type="object">
  ...
  <Expandable title="Field Details">
    <ResponseField name="id" type="string">
      ...
      Example: `"task_01KC0JZCMTMQ70D68XTM56Q5D0"`
    </ResponseField>
    ...
    <ResponseField name="completed" type="integer">
      Task completion timestamp (Unix timestamp)
        ...
        <ResponseField name="characters" type="array">
          ...
          <Expandable title="Character object">
            <ResponseField name="id" type="string">
              ...
              Example: `"ch_6937998961208191a45ef08447a554df"`
            </ResponseField>

            <ResponseField name="display_name" type="string">
              Character display name

              Example: `"Turbo Whiskers"`
            </ResponseField>
            ...
            <ResponseField name="username" type="string">
              Character username, can be referenced in prompt using `@username`

              Example: `"duksvfkf.turbo_whis"`
            </ResponseField>
          </Expandable>
        </ResponseField>
      </Expandable>
