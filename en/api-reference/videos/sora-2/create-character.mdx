...
<ParamField body="timestamps" type="string" required>
  ...
  In seconds, format: `"start_second,end_second"`
...
<ParamField body="url" type="string">
  Video URL containing the character to create
...
<ParamField body="from_task" type="string">
  Previously generated video task ID

  Create a character from an already generated video task
...
<ResponseField name="data" type="array">
  ...
  <Expandable title="Array Elements">
    ...
    <ResponseField name="task_id" type="string">
      ...
      Once completed, you can use this character task ID to reference the character via the `character_url` parameter in video generation
    </ResponseField>
  </Expandable>
</ResponseField>
