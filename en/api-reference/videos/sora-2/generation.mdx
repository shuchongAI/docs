...
<ParamField body="model" type="string" default="sora-2" required>
  ...
  - `sora-2-vip` - VIP version, upgraded sora-2
  - `sora-2-pro` - Professional version, supports longer duration

  Example: `"sora-2"` or `"sora-2-vip"` or `"sora-2-pro"`
</ParamField>
...
<ParamField body="prompt" type="string" required>
  ...
  **💡 @Character Reference Feature:**
  ...
  - The character's `username` can be obtained via the [Query Character API](/en/api-reference/videos/sora-2/query-character)
...
<ParamField body="thumbnail" type="boolean">
  ...
  **⚠️ Note:** Thumbnails are only saved for 1 hour. Please contact the administrator if needed.
