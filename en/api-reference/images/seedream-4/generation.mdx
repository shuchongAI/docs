...
<ParamField body="n" type="integer">
  ...
  **Note:** The actual number of images that can be generated is affected by both this parameter and the number of input reference images. The total of reference images + generated images must be ≤ 15
...
<ParamField body="watermark" type="boolean" default="true">
  ...
  - `true`: Add "AI Generated" watermark text at the bottom right corner of the image
