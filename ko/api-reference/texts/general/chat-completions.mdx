...
<ParamField body="messages" type="array" required>
  ...
  - `role`: Role type (`system`, `user`, `assistant`)
  - `content`: Message content (string or multimodal content array)
</ParamField>
...
- `o1-mini` - Lightweight version of reasoning model

### Anthropic Series
- `claude-3-5-sonnet` - Latest Claude 3.5 model
- `claude-3-5-haiku` - Fast response version
- `claude-3-opus` - Most powerful Claude 3 model

### Google Series
- `gemini-2.0-flash` - Latest Gemini 2.0 fast version
- `gemini-1.5-pro` - Gemini 1.5 professional version
- `gemini-1.5-flash` - Gemini 1.5 fast version

### Meta Series
- `llama-3.3-70b` - Llama 3.3 70B parameter model
- `llama-3.1-405b` - Llama 3.1 ultra-large model
- `llama-3.1-70b` - Llama 3.1 70B model

### Mistral Series
- `mistral-large` - Mistral's most powerful model
- `mistral-small` - Lightweight and efficient version
- `mistral-nemo` - Purpose-optimized model
