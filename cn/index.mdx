---
title: "APIMart — OpenAI 兼容 API 网关（GPT-5、Claude、Gemini）"
...
支持 GPT-5、GPT-4o、Claude Sonnet 4.5、Gemini 2.0 Flash。OpenAI 兼容端点，支持流式传输和低延迟。

<Card title="聊天补全 API" icon="message" href="/cn/api-reference/texts/general/chat-completions">
  通过 `/v1/chat/completions` 端点访问
</Card>

### 图像生成端点

支持 GPT-4o Image、Gemini 2.5 Flash Image 模型。OpenAI 风格端点，无缝集成。

<Card title="图像生成 API" icon="image" href="/cn/api-reference/images/GPT-4o-image/generation">
  通过 `/v1/images/generations` 端点访问
</Card>
