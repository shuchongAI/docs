...
### OpenAIシリーズ
- `gpt-4o` - 最新のマルチモーダルフラッグシップモデル
- `gpt-4o-mini` - 軽量版、コストパフォーマンスに優れる
- `o1` - 推論最適化モデル
- `o1-mini` - 推論モデルの軽量版

### Anthropicシリーズ
- `claude-3-5-sonnet` - 最新のClaude 3.5モデル
- `claude-3-5-haiku` - 高速レスポンス版
- `claude-3-opus` - 最も強力なClaude 3モデル

### Googleシリーズ
- `gemini-2.0-flash` - 最新のGemini 2.0高速版
- `gemini-1.5-pro` - Gemini 1.5プロフェッショナル版
- `gemini-1.5-flash` - Gemini 1.5高速版

### Metaシリーズ
- `llama-3.3-70b` - Llama 3.3 70Bパラメータモデル
- `llama-3.1-405b` - Llama 3.1超大規模モデル
- `llama-3.1-70b` - Llama 3.1 70Bモデル

### Mistralシリーズ
- `mistral-large` - Mistralの最強モデル
- `mistral-small` - 軽量で効率的なバージョン
- `mistral-nemo` - 目的最適化モデル
