...
"
api: "POST https://apimart.ai/v1/responses"
---

<RequestExample>

```bash cURL
curl https://apimart.ai/v1/responses \
...
url = "https://apimart.ai/v1/responses"
...
const url = "https://apimart.ai/v1/responses";
...
public class Main {
    public static void main(String[] args) throws Exception {
        String url = "https://apimart.ai/v1/responses";
...
url = URI("https://apimart.ai/v1/responses")
...
let url = URL(string: "https://apimart.ai/v1/responses")!
...
class Program
{
    ...
    {
        var url = "https://apimart.ai/v1/responses";
...
int main(void) {
    ...
    if(curl) {
        const char *url = "https://apimart.ai/v1/responses";
        const char *payload = "{"
            "\"model\":\"gpt-5\","
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        NSURL *url = [NSURL URLWithString:@"https://apimart.ai/v1/responses"];
...
let url = "https://apimart.ai/v1/responses"
...
void main() async {
  final url = Uri.parse('https://apimart.ai/v1/responses');
...
<ParamField header="Authorization" type="string" required>
  ...
  [APIキー管理](https://apimart.ai/dashboard/keys)にアクセスしてAPIキーを取得してください
